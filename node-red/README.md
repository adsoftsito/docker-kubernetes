...
![Version: 0.26.0](https://img.shields.io/badge/Version-0.26.0-informational?style=for-the-badge) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=for-the-badge) ![AppVersion: 3.0.2](https://img.shields.io/badge/AppVersion-3.0.2-informational?style=for-the-badge)
...
```bash
helm install node-red oci://ghcr.io/schwarzit/charts/node-red --version 0.26.0
```
...
```bash
helm install node-red node-red/node-red --version 0.26.0
```
